...
function GeneralTab({ config, onChange }) {
  ...
  return (
    <table className="form-table w-full"><tbody>
      <TextRow label="Site Title" value={b.name} onChange={v => set('name', v)} placeholder="U Vape" />
      ...
      <TextRow label="Tagline" value={b.tagline} onChange={v => set('tagline', v)} placeholder="Premium vape" description="In a few words, explain what this site is about." />
      <TextRow label="Footer Brand Name" value={b.footerBrandName} onChange={v => set('footerBrandName', v)} placeholder="U VAPE" description="Large animated text shown at the bottom of the footer." />
      <TextRow label="Copyright Text" value={b.copyrightText} onChange={v => set('copyrightText', v)} placeholder="U VAPE — ALL RIGHTS RESERVED © 2026." />
      ...
      <TextRow label="WhatsApp Number" value={b.whatsappNumber} onChange={v => set('whatsappNumber', v)} placeholder="+1234567890" description="Store WhatsApp contact number with country code." />
                  ...
                  <div className="border-t border-[#e0e0e0] pt-5">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="e.g. Explore our latest collection of premium vape devices."
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="px-4 py-3 space-y-2">
                <input
                  type="text"
                  value={config.brand?.copyrightText ?? "U VAPE — ALL RIGHTS RESERVED © 2026."}
                  onChange={e => onChange({ ...config, brand: { ...(config.brand || {}), copyrightText: e.target.value } })}
                  placeholder="e.g. U VAPE — ALL RIGHTS RESERVED © 2026."
              ...
              {loadingRedirects ? (
                ...
                redirects.map((item) => (
                  <tr key={item._id} className="hover:bg-[#f6f7f7]">
                    ...
                    <td className="px-4 py-3">
                      <span className={`px-2 py-0.5 rounded text-[11px] font-semibold ${item.statusCode === 301 ? "bg-green-50 text-green-700 border border-green-200" : "bg-blue-50 text-blue-700 border border-blue-200"
                        }`}>
                        {item.statusCode}
                      </span>
                    </td>
